...
@section('head')
    ...
    <link rel="stylesheet" type="text/css" href="{{url('js/quagga/example/css/styles.css')}}" />
@endsection
...
@section('content')
    ...
    <script src="{{url('js/quagga/dist/quagga.js')}}" type="text/javascript"></script>
    <script src="{{url('js/quagga/example/live_w_locator.js')}}" type="text/javascript"></script>
@endsection
